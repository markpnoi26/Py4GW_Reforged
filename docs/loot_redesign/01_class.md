...
- **A model-id based lookup** (e.g. joining `legacy/salvage_mapping.json`, 2021 entries of
...
separate document by design: see `02_implementation_spec.md`, which carries the decision register
