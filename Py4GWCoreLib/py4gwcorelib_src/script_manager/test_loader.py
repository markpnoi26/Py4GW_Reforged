...
Run (-t must be the module's own folder, or discovery walks up into Py4GWCoreLib/__init__.py):
...
class ProtectionTests(Sandbox):
    ...
    def test_corelib_is_never_purgeable(self):
        ...
        try:
            ...
            if getattr(sys.modules.get("Py4GWCoreLib"), "__file__", None) is None:
                sys.modules.pop("Py4GWCoreLib", None)
