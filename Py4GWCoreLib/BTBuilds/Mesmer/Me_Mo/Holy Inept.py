            ...
            [
                ...
                sequence(
                    ...
                    selector(
                        ...
                        cast(self, "PowerDrain",
                             lambda: mesmer().InspirationMagic.Power_Drain()),
                        cast(self, "Ineptitude",
                             lambda: mesmer().IllusionMagic.Ineptitude()),
                        cast(self, "WanderingEye",
                             lambda: mesmer().IllusionMagic.Wandering_Eye()),
                        guarded_cast(
                            self, "ArcaneConundrum",
                            lambda: self.IsSkillEquipped(Arcane_Conundrum_ID),
                            lambda: mesmer().IllusionMagic.Arcane_Conundrum(),
                        ),
                        cast(self, "JudgesInsight",
                             lambda: self.skills.Monk.SmitingPrayers.Judges_Insight()),
                        guarded_cast(
