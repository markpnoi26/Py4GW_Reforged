            ...
            [
                ...
                sequence(
                    ...
                    selector(
                        ...
                        cast(self, "PowerDrain50",
                             lambda: inspiration().Power_Drain(energy_threshold_pct=0.50)),
                        cast(self, "DrainEnchantment50",
                        ...
                        guarded_cast(self, "ArcaneConundrum", equipped(Arcane_Conundrum_ID),
