    ...
    def build_rotation_tree(self) -> BehaviorTree:
        ...
        return rotation_tree(
            ...
            [
                ...
                guarded_cast(self, "FleshOfMyFlesh", equipped(Flesh_of_My_Flesh_ID),
                             lambda: self.flesh_of_my_flesh()),
                guarded_cast(self, "EbonBattleStandardOfCourage",
