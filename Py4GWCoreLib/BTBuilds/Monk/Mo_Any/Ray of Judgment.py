...
class Ray_of_Judgment(BldMgrBT):
    ...
    def seed_blackboard(self, blackboard: dict) -> None:
        ...
        blackboard["roj_arcane_echo_active"] = bool(
            Routines.Checks.Agents.HasEffect(player_id, Arcane_Echo_ID))
    ...
    def roj_chain_ready(self) -> bool:
        ...
        return (
            roj_cast_ts_ms > self.last_ymlad_chain_ts_ms
    ...
    def ray_of_judgment_echo_copy(self):
        ...
        return (yield from self.skills.Monk.SmitingPrayers.Ray_of_Judgment(
            exclude_target_id=last_target_id))
            ...
            [
                ...
                sequence(
                    ...
                    selector(
                        ...
                        guarded_cast(
                            self, "EbonBattleStandardOfWisdom",
                            lambda node: no_echo(node)
                            and self.IsSkillEquipped(Ebon_Battle_Standard_of_Wisdom_ID),
