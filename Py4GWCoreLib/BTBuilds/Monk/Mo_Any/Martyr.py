        ...
        return rotation_tree(
            ...
            [
                ...
                cast(self, "RemoveHexHigh",
                     lambda: monk().NoAttribute.Remove_Hex(min_priority=HexRemovalPriority.HIGH)),
                cast(self, "CureHexHigh",
                     lambda: monk().HealingPrayers.Cure_Hex(min_priority=HexRemovalPriority.HIGH)),
                guarded_cast(
                    self, "DwaynasKiss",
