...
from Py4GWCoreLib import AgentArray, BldMgrBT, Profession, Range, Routines
    ...
    def build_rotation_tree(self) -> BehaviorTree:
        return rotation_tree(
            ...
            [
                ...
                cast(self, "SoulTaker",
                     lambda: self.skillbook.Necromancer.SoulReaping.Soul_Taker(refresh_window_ms=2000)),
                cast(self, "DrunkenMaster",
                     lambda: self.skillbook.Any.PvE.Drunken_Master(refresh_window_ms=2000)),
                cast(self, "ScytheSpike",
                     lambda: self.scythe_spike(self.get_player_contact_count())),
            ],
        )
