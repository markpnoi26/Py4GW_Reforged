...
class Assassins_Promise_Death_Magic(BldMgrBT):
    ...
    def build_rotation_tree(self) -> BehaviorTree:
        ...
        return rotation_tree(
            ...
            [
                guarded_cast(self, "Masochism", equipped(Masochism_ID),
                             lambda: necro().SoulReaping.Masochism()),
                guarded_cast(self, "RisingBile", equipped(Rising_Bile_ID),
                             lambda: necro().DeathMagic.Rising_Bile()),
                guarded_cast(self, "EbonBattleStandardOfHonor",
                             equipped(Ebon_Battle_Standard_of_Honor_ID),
                             lambda: anyskills().NoAttribute.Ebon_Battle_Standard_of_Honor()),
                cast(self, "AssassinsPromise",
                     lambda: self.skills.Assassin.DeadlyArts.Assassins_Promise()),
                ...
                guarded_cast(self, "YouMoveLikeADwarf", equipped(You_Move_Like_a_Dwarf_ID),
                             lambda: anyskills().NoAttribute.You_Move_Like_a_Dwarf()),
                guarded_cast(self, "FinishHim", equipped(Finish_Him_ID),
                             lambda: anyskills().NoAttribute.Finish_Him()),
