...
from Py4GWCoreLib import AgentArray, BldMgrBT, GLOBAL_CACHE, Profession, Range, Routines, Utils
    ...
    def build_rotation_tree(self) -> BehaviorTree:
        ...
        return rotation_tree(
            ...
            [
                ...
                cast(self, "Contagion",
                     lambda: self.skills.Necromancer.DeathMagic.Contagion()),
                cast(self, "FoulFeastOverloaded", lambda: self.foul_feast(min_conditions=4)),
                guarded_cast(self, "BurningSpeed", equipped(BURNING_SPEED_ID),
                             lambda: self.skills.Elementalist.FireMagic.Burning_Speed()),
                guarded_cast(self, "PoisonedHeart", equipped(POISONED_HEART_ID),
                             lambda: self.skills.Necromancer.Curses.Poisoned_Heart()),
                guarded_cast(self, "SignetOfAgony", equipped(SIGNET_OF_AGONY_ID),
                ...
                guarded_cast(self, "DeathsCharge", equipped(DEATHS_CHARGE_ID),
                             lambda: self.skills.Assassin.ShadowArts.Deaths_Charge()),
                guarded_cast(
                    self, "ShadowSanctuary",
                ...
                cast(self, "AutoAttack",
                     lambda: self.AutoAttack(target_type="EnemyClustered")),
            ],
        )
