...
class Seven_Weapon_Stance_Axe(BldMgrBT):
    ...
    def build_rotation_tree(self) -> BehaviorTree:
        ...
        return rotation_tree(
            ...
            [
                cast(self, "SevenWeaponStance",
                     lambda: warrior().Strength.Seven_Weapon_Stance()),
                guarded_cast(
                    self, "AntidoteSignet",
                ...
                cast(self, "ExecutionersStrike",
                     lambda: warrior().AxeMastery.Executioners_Strike()),
                cast(self, "CycloneAxe",
                     lambda: warrior().AxeMastery.Cyclone_Axe()),
                cast(self, "WhirlwindAttack",
                     lambda: warrior().NoAttribute.Whirlwind_Attack()),
            ],
        )
