...
class Pre_Searing_ele(BldMgrBT):
    ...
    def build_rotation_tree(self) -> BehaviorTree:
        ...
        simple_cast = lambda skill_id: (lambda: self.CastSkillID(
            skill_id=skill_id, log=False, aftercast_delay=250))
        return rotation_tree(
            ...
            [
                ...
                sequence(
                    ...
                    selector(
                        "AggroRungs",
                        guarded_cast(self, "FireStorm", equipped(Fire_Storm_ID),
                                     simple_cast(Fire_Storm_ID)),
