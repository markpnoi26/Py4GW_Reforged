...
class Ether_Renewal_Prot_Infuser(BldMgrBT):
    ...
    def vital_blessing_self_upkeep(self):
        not_has_vital_blessing = lambda: not Routines.Checks.Effects.HasBuff(
            Player.GetAgentID(), Vital_Blessing_ID
        )
    ...
    def build_rotation_tree(self) -> BehaviorTree:
        ...
        return rotation_tree(
            ...
            [
                cast(self, "AuraOfRestoration",
                     lambda: self.skills.Elementalist.EnergyStorage.Aura_of_Restoration()),
                guarded_cast(
                    self, "VitalBlessing",
                ...
                sequence(
                    ...
                    selector(
                        ...
                        cast(self, "ProtectiveSpirit",
                             lambda: monk().ProtectionPrayers.Protective_Spirit()),
                        cast(self, "ReversalOfFortune",
                             lambda: monk().ProtectionPrayers.Reversal_of_Fortune()),
                        cast(self, "EtherRenewal",
                             lambda: self.skills.Elementalist.EnergyStorage.Ether_Renewal()),
                    ),
                ),
            ],
        )
