__script__ = {
    "name": "Farmer Hamnet (Presearing Leveler)",
    "function": "leveler",
    "tags": [],
...
def main():
    ...
    try:
        # Bot control window
        expanded, _ = ImGui.begin_with_close("Simple Farming Bot", None, PyImGui.WindowFlags(PyImGui.WindowFlags.AlwaysAutoResize))
        if expanded:
