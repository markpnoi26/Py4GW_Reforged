    ...
    def __init__(self, pathing_maps):
        ...
        for layer in pathing_maps:
            ...
            for t in layer.trapezoids:
                ...
                self.neighbors[t.id] = list(t.neighbor_ids)
...
class AStar:
    def __init__(self, navmesh: NavMesh, z_cost: float = 100.0):
    ...
    def heuristic(self, a: int, b: int) -> float:
        ...
        dz = abs(self.navmesh.get_layer(a) - self.navmesh.get_layer(b)) * self.z_cost
